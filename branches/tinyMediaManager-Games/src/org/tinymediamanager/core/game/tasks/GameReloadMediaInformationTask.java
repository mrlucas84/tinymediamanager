...
/**
 * The Class GameReloadMediaInformationTask, to explicit reload mediainformation.
 * 
 * @author Manuel Laggner
 */
public class GameReloadMediaInformationTask extends TmmThreadPool {
  private static final Logger LOGGER = LoggerFactory.getLogger(GameReloadMediaInformationTask.class);

  private List<Game>          gamesToReload;

  public GameReloadMediaInformationTask(List<Game> games) {
    gamesToReload = new ArrayList<Game>(games);
