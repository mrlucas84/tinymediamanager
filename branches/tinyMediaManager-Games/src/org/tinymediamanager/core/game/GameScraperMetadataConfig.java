...
/**
 * The Class GameScraperMetadataConfig.
 * 
 * @author Manuel Laggner
 */
@XmlRootElement(name = "GameScraperMetadata")
public class GameScraperMetadataConfig extends AbstractModelObject {
  ...
  public GameScraperMetadataConfig() {
  }
   ...
   *          the new runtime
   */
  public void setPublisher(boolean newValue) {
    boolean oldValue = this.publisher;
  ...
  /**
   * Sets the collection (game set).
   * 
   * @param newValue
   *          the new collection (game set)
   */
