...
import org.tinymediamanager.core.game.GameExporter;
...
/**
 * The Class GameExporter.
 * 
 * @author Manuel Laggner
 */
public class GameExporterDialog extends JDialog {

  private static final long           serialVersionUID = 4085262825778794266L;
  private static final ResourceBundle BUNDLE           = ResourceBundle.getBundle("messages", new UTF8Control()); //$NON-NLS-1$
  private static final Logger         LOGGER           = LoggerFactory.getLogger(GameExporterDialog.class);
   ...
   *          the games to export
   */
  public GameExporterDialog(List<Game> gamesToExport) {
    setTitle(BUNDLE.getString("game.export")); //$NON-NLS-1$
    setName("gameExporter");
    ...
    btnExport.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        ...
        if (selectedTemplate != null) {
          try {
            GameExporter.export(games, selectedTemplate.getPath(), tfExportDir.getText());
          }
          catch (Exception e) {
            LOGGER.error("Error exporting games: " + e.getMessage());
          }
          GameExporterDialog.this.setVisible(false);
          dispose();
        }
      }
    });
    ...
    games = gamesToExport;
    templatesFound = GameExporter.findTemplates();
    initDataBindings();
  }
