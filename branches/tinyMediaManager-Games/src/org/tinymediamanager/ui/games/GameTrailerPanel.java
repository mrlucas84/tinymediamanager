...
/**
 * The Class GameTrailerPanel.
 * 
 * @author Manuel Laggner
 */
public class GameTrailerPanel extends JPanel {
  ...
  /** The logger. */
  private static final Logger                  LOGGER            = LoggerFactory.getLogger(GameTrailerPanel.class);
   ...
   *          the model
   */
  public GameTrailerPanel(GameSelectionModel model) {
    ...
    PropertyChangeListener propertyChangeListener = new PropertyChangeListener() {
      public void propertyChange(PropertyChangeEvent propertyChangeEvent) {
        ...
        // react on selection of a game and change of a trailer
        if ((source.getClass() == GameSelectionModel.class && "selectedGame".equals(property))
            || (source.getClass() == Game.class && "trailer".equals(property))) {
          trailerEventList.clear();
          trailerEventList.addAll(gameSelectionModel.getSelectedGame().getTrailers());
          try {
