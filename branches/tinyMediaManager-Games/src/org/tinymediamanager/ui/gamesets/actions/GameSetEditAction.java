...
import org.tinymediamanager.ui.gamesets.dialogs.GameSetEditorDialog;
 ...
 */
public class GameSetEditAction extends AbstractAction {
  private static final long           serialVersionUID = 1848573591741154631L;
  private static final ResourceBundle BUNDLE           = ResourceBundle.getBundle("messages", new UTF8Control()); //$NON-NLS-1$

  public GameSetEditAction(boolean withTitle) {
    if (withTitle) {
      putValue(NAME, BUNDLE.getString("gameset.edit")); //$NON-NLS-1$
    }
    ...
    putValue(SHORT_DESCRIPTION, BUNDLE.getString("gameset.edit")); //$NON-NLS-1$
  }
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    for (GameSet gameSet : selectedGameSets) {
      GameSetEditorDialog editor = new GameSetEditorDialog(gameSet, selectedGameSets.size() > 1 ? true : false);
