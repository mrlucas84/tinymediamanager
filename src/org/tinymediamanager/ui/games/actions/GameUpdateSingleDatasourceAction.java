...
/**
 * GameUpdateSingleDatasourceAction - update all games from a single datasource
 * 
 * @author Manuel Laggner
 */
public class GameUpdateSingleDatasourceAction extends AbstractAction {
  private static final long           serialVersionUID = 6885253964781733478L;
  private static final ResourceBundle BUNDLE           = ResourceBundle.getBundle("messages", new UTF8Control()); //$NON-NLS-1$

  private String                      datasource;

  public GameUpdateSingleDatasourceAction(String datasource) {
  ...
  /*
   * (non-Javadoc)Cross.png
   * 
   * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
   */
  @Override
  public void actionPerformed(ActionEvent e) {
    TmmSwingWorker task = new GameUpdateDatasourceTask(datasource);
