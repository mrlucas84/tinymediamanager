...
import org.tinymediamanager.core.game.tasks.GameRenameTask;
 ...
 * 
 */
public class GameSetRenameAction extends AbstractAction {
  private static final ResourceBundle BUNDLE           = ResourceBundle.getBundle("messages", new UTF8Control()); //$NON-NLS-1$
  private static final long           serialVersionUID = 1677285197819210130L;

  public GameSetRenameAction() {
    putValue(NAME, BUNDLE.getString("game.rename")); //$NON-NLS-1$
    ...
    putValue(SHORT_DESCRIPTION, BUNDLE.getString("game.rename")); //$NON-NLS-1$
  }

  @Override
  public void actionPerformed(ActionEvent arg0) {
    List<Game> selectedGames = GameSetUIModule.getInstance().getSelectionModel().getSelectedGamesRecursive();

    // rename
    TmmSwingWorker renameTask = new GameRenameTask(selectedGames);
